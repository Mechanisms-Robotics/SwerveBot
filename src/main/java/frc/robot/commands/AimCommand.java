...
public class AimCommand extends ParallelCommandGroup {
  ...
  public AimCommand(Supplier<Double> driverX,
                     Supplier<Double> driverY,
                     Supplier<Double> rotation, Hood hood, Swerve swerve, Shooter shooter, Accelerator accelerator, Spindexer spindexer, PhotonCamera camera) {
