...
public class FlywheelSpeed {
    ...
    static {
        ...
        speedMap.put(new InterpolatingDouble(longRangeZone - rampZone), new InterpolatingDouble(4800.0));
        speedMap.put(new InterpolatingDouble(longRangeZone + rampZone), new InterpolatingDouble(5200.0));
